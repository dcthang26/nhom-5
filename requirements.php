...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        <div class="card bg-warning text-white">
            <div class="card-body text-center">
                <h6>Không có yêu cầu đặc biệt</h6>
                <h3><?= count(array_filter($customers, fn($c) => empty($c['special_requirements']))) ?></h3>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Yêu cầu đặc biệt của khách hàng</h3>
    </div>
    <div class="card-body">
                ...
                <?php if(empty($customers)): ?>
                    ...
                    <?php else:?>
                        <?php foreach($customers as $index => $c): ?>
                            <tr>
                                <strong><td><?= htmlspecialchars($c['name']) ?></strong><br>
                            ...
                            <div class="modal fade" id="editModal<?= $c['id']?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="<?= BASE_URL?>guide/update-requirement" method="post">
