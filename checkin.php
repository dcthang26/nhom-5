        ...
        <?php if (empty($customers)): ?>
          ...
          <?php else: ?>
            ...
            <tr>
              ...
              <td class="text-center">
                <?php if ($c['check_in_status'] == 'Đã check-in'): ?>
                  <a href="<?=  BASE_URL  ?>guide/check?id=<?= $c['id'] ?>&status=Chưa check-in" class="btn btn-sm btn-warning">
                    <i class="bi bi-x-circle"></i> Hủy
                  </a>
                  <?php else: ?>
                     <a href="<?=  BASE_URL  ?>guide/check?id=<?= $c['id'] ?>&status=Đã check-in" class="btn btn-sm btn-success">
