...
?>
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                <?php foreach ($diaries as $d): ?>
                    ...
                    <div class="card-body">
                        <p><?= n12br(htmlspecialchars($d['content']))?></p>
                        <?php if ($d['incidents']):?>
                            <div class="alert alert-warning">
                                <strong>Sự cố:</strong><?= n12br(htmlspecialchars($d['incidents']))?>

                            </div>
                            <?php endif;?>
                            <?php if($d['customer-feedback']):?>
                                <div class="alert alert-info">
                                    <strong>Phàn hồi khách:</strong> <?= htmlspecialchars($d['customer_feedback']) ?>
                                </div>
                                <?php endif;?>
    ...
    <div class="modal fade" id="addDiaryModal" tanbindex="-1">
                ...
                <form method="post" action="<?= BASE_URL?>guide/save-diary">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="">Ngày <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="content" id="content" rows="4" class="form-control" placeholder="Ghi chú hành trình, hoạt động..." required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="">Sự cố (nếu có)</label>
                                <textarea name="incidents" id="incidents" rows="3" class="form-control" placeholder="Ghi lại sự cố và cách xử lý..."></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="">Phản hồi của khách (nếu có)</label>
                                <textarea name="customer_feedback" id="customer_feedback" rows="3" class="form-control" placeholder="Phản hồi, góp ý của khách..."></textarea>
                            </div>
