                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <a href="<?= BASE_URL?>guide/customers" class="btn btn-outline-info w-100 p-3">
                            ...
                            <small>Thông tích khách tham gia</small>
                        </a>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <a href="<?= BASE_URL?>guide/diary" class="btn btn-outline-success w-100 p-3">
                            <i class="bi bi-journal-text fs-4 d-block mb-2"></i>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <small class="text-muted"><?= $_SESSION['user_name']??'HSV'?></small>
                                </div>
                            </div>
                        </div>
                    </div>
